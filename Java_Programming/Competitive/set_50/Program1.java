/*
    write a java program to accept two file names from user and open first file and
    create new file(second name)and copy the data from first file into newly created file.
*/
import java.io.*;
import java.util.*;
